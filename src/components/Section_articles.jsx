...
function Section_articles() {
  return (
    <section className="section flex flex-col    m-6 pt-10 md:grid md:grid-cols-2 gap-6 lg:m-28  justify-items-center ">
      <article className="relative h-72 lg:h-80 mb-6 lg:w-80 xl:w-96">
        <span className="section__number">1</span>
        <div className="article1 articles flex items-center justify-center">
          <BrainIco/>
        </div>
        <h3 className="title text-2xl">CREATIVIDAD SIN LÍMITES PARA IMPULSAR TU MARCA</h3>
        <p className="text-xs">
    ...
    <article className="relative h-72 lg:h-80 mb-6 lg:w-80 xl:w-96">
      ...
      <h3 className='title text-2xl'>AGILIDAD Y EFICIENCIA EN CADA PROYECTO</h3>
    ...
    <article className="relative h-72 lg:h-80 mb-6 lg:w-80 xl:w-96">
      ...
      <h3 className='title text-2xl '>TECNOLOGÍA PARA RESULTADOS ÓPTIMOS</h3>
    ...
    <article className="relative h-72 lg:h-80 mb-6 lg:w-80 xl:w-96">
      ...
      <h3 className='title text-2xl '>EQUIPO DE EXPERTOS APASIONADOS Y DEDICADOS</h3>
