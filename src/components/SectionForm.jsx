...
function SectionForm() {
  ...
  return (
    <section className="form text-white border pt-10">
      <form className="lg:m-16 xl:m-24 2xl:m-48 3xl:m-60" onSubmit={handleSubmit}>
      <div className="form_grid">
      <section className="from_message flex flex-col gap-2 sm:ml-6 sm:mr-6 md:w-96 md:mt-4 md:items-start md:ml-6 2xl:w-full ">
